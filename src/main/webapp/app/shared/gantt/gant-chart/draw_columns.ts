...
export const draw_bottom = function(column, vTmpRow, vAdditionalHeaders) {
    if ('vShowRes' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gresource', '\u00A0');
    }
    if ('vShowDur' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gduration', '\u00A0');
    }
    if ('vShowComp' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gpccomplete', '\u00A0');
    }
    if ('vShowStartDate' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gstartdate', '\u00A0');
    }
    if ('vShowEndDate' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning genddate', '\u00A0');
    }
    if ('vShowPlanStartDate' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gplanstartdate', '\u00A0');
    }
    if ('vShowPlanEndDate' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gplanenddate', '\u00A0');
    }
    if ('vShowCost' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gcost', '\u00A0');
    }
    ...
    if ('vShowAddEntries' == column) {
        newNode(vTmpRow, 'td', null, 'gspanning gaddentries', '\u00A0');
    }
};
...
export const draw_task_headings = function(column, vTmpRow, vLangs, vLang, vAdditionalHeaders) {
    if ('vShowRes' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gresource', vLangs[vLang]['resource']);
    }
    if ('vShowDur' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gduration', vLangs[vLang]['duration']);
    }
    if ('vShowComp' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gpccomplete', vLangs[vLang]['comp']);
    }
    if ('vShowStartDate' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gstartdate', vLangs[vLang]['startdate']);
    }
    if ('vShowEndDate' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading genddate', vLangs[vLang]['enddate']);
    }
    if ('vShowPlanStartDate' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gplanstartdate', vLangs[vLang]['planstartdate']);
    }
    if ('vShowPlanEndDate' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gplanenddate', vLangs[vLang]['planenddate']);
    }
    if ('vShowCost' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gcost', vLangs[vLang]['cost']);
    }
    if ('vAdditionalHeaders' == column && vAdditionalHeaders) {
        for (const key in vAdditionalHeaders) {
            const header = vAdditionalHeaders[key];
    ...
    if ('vShowAddEntries' == column) {
        newNode(vTmpRow, 'td', null, 'gtaskheading gaddentries', vLangs[vLang]['addentries']);
    }
};

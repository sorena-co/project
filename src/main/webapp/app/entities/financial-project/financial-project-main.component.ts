...
@Component({
    selector: 'jhi-financial-project-main',
    templateUrl: './financial-project-main.component.html'
})
export class FinancialProjectMainComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.financialProjectService
            .getFinancialProjectMain(this.projectId)
            .subscribe(
                (res: HttpResponse<FinancialProjectMain>) => (this.financialProjectMain = res.body),
